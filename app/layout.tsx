...
export const metadata: Metadata = {
  ...
  description: 'Explore heritage sites, cultural events, virtual tours, and plan your visit with crowd predictions. Discover the rich history and culture of amazing destinations.',
  generator: 'v0.app',
