...
const gujaratPlaces: HeritagePlace[] = [
  {
    ...
    panoImage: "https://photo-sphere-viewer-data.netlify.app/assets/sphere.jpg",
    duration: "1-2 hours",
  ...
  },
  {
    ...
    panoImage: "https://photo-sphere-viewer-data.netlify.app/assets/sphere-mobile.jpg",
    duration: "3-4 hours",
    entryFee: "₹40 (Indians) / ₹600 (Foreigners)",
    timings: "8:00 AM – 6:00 PM",
  ...
  },
  {
    ...
    panoImage: "https://photo-sphere-viewer-data.netlify.app/assets/sphere-test.jpg",
    duration: "3-4 hours",
    entryFee: "₹40",
...
export const nearbyRecommendations: NearbyRecommendation[] = [
  { id: "nr1", name: "Patan Heritage Café", type: "cafe", image: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&q=80", lat: 23.861, lng: 72.104, rating: 4.3, description: "Cozy café near Rani ki Vav with traditional Gujarati snacks and masala chai.", nearbyPlaceId: "g1" },
  { id: "nr2", name: "Pavagadh Viewpoint", type: "scenic", image: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=400&q=80", lat: 22.488, lng: 73.537, rating: 4.7, description: "Stunning hilltop views over the Champaner forest and plains.", nearbyPlaceId: "g2" },
  { id: "nr3", name: "Desert Trail Café – Kutch", type: "cafe", image: "https://images.unsplash.com/photo-1559925393-8be0ec41b513?w=400&q=80", lat: 23.889, lng: 70.213, rating: 4.1, description: "Rustic café with Kutchi specialties near Dholavira.", nearbyPlaceId: "g3" },
  { id: "nr4", name: "Somnath Beach Promenade", type: "scenic", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&q=80", lat: 20.890, lng: 70.403, rating: 4.5, description: "Beautiful coastal walk along the Arabian Sea.", nearbyPlaceId: "g5" },
  { id: "nr5", name: "Dwarka Sunset Point", type: "scenic", image: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=400&q=80", lat: 22.239, lng: 68.970, rating: 4.6, description: "Watch the sun set over the Arabian Sea from Dwarka's coast.", nearbyPlaceId: "g6" },
  { id: "nr6", name: "Modhera Heritage Café", type: "cafe", image: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80", lat: 23.585, lng: 72.135, rating: 4.1, description: "Refreshments near the Sun Temple with local specialties.", nearbyPlaceId: "g7" },
  { id: "nr7", name: "Jaipur Blue Pottery Studio", type: "cultural", image: "https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?w=400&q=80", lat: 26.925, lng: 75.830, rating: 4.4, description: "Live demonstrations of Jaipur's famous blue pottery craft.", nearbyPlaceId: "r2" },
  { id: "nr8", name: "Nahargarh Viewpoint", type: "scenic", image: "https://images.unsplash.com/photo-1449034446853-66c86144b0ad?w=400&q=80", lat: 26.940, lng: 75.850, rating: 4.7, description: "Panoramic views of the Pink City from the Aravalli Hills.", nearbyPlaceId: "r1" },
  { id: "nr9", name: "Jodhpur Spice Garden", type: "restaurant", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&q=80", lat: 26.300, lng: 73.020, rating: 4.5, description: "Authentic Rajasthani cuisine with a rooftop view of the Blue City.", nearbyPlaceId: "r6" },
  { id: "nr10", name: "Mandore Gardens", type: "cultural", image: "https://images.unsplash.com/photo-1585320806297-9794b3e3eeae?w=400&q=80", lat: 26.310, lng: 73.010, rating: 4.2, description: "Historic cenotaphs and lush gardens near Jodhpur.", nearbyPlaceId: "r6" },
  { id: "nr11", name: "Sam Sand Dunes", type: "scenic", image: "https://images.unsplash.com/photo-1444491741275-3747c53c99b4?w=400&q=80", lat: 26.875, lng: 70.767, rating: 4.8, description: "Golden sand dunes for sunset camel safaris near Jaisalmer.", nearbyPlaceId: "r7" },
  { id: "nr12", name: "Lake Pichola Boat Ride", type: "scenic", image: "https://images.unsplash.com/photo-1534008843454-b39e52a6a24f?w=400&q=80", lat: 24.576, lng: 73.683, rating: 4.9, description: "Serene boat ride at sunset on Lake Pichola with views of the Lake Palace.", nearbyPlaceId: "r9" },
  { id: "nr13", name: "Mount Abu Nakki Lake", type: "scenic", image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&q=80", lat: 24.598, lng: 72.712, rating: 4.4, description: "Tranquil boating on Nakki Lake surrounded by Aravalli peaks.", nearbyPlaceId: "r10" },
  { id: "nr14", name: "Laxmi Vilas Café", type: "cafe", image: "https://images.unsplash.com/photo-1550989460-0adf9ea622e2?w=400&q=80", lat: 22.301, lng: 73.182, rating: 4.3, description: "Heritage café within the palace grounds serving royal-style snacks.", nearbyPlaceId: "g9" },
]
